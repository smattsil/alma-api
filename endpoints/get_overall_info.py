...
async def get_overall_info(school, username, password):
    payload = {
        'username': username,
        'password': password
    }
    ...
    async with AsyncClient(timeout=None) as client:
        ...
        rankedRating = round(sumOfGrades/totalPossible * 1000)

        return {'username': username, 'gpa': gpa, 'amountOfAPlus': amountOfAPlus, 'rankedRating': rankedRating}
